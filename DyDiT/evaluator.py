...
INCEPTION_V3_PATH = "/path/imagenet_fid/classify_image_graph_def.pb"
...
def main():
    ...
    metric_list = ['IS', "FID", "sFID", "Precision", "Recall"]
    result_list = [IS, FID, sFID, prec, recall]
    with open(args.sample_batch.replace(".npz", ".csv"), mode='w', newline='') as f:
        writer = csv.writer(f)
